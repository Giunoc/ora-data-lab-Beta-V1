...
const eduData = {
    ...
    quiz: [
        {
            question: "Qual è la percentuale di studenti degli Istituti Professionali con genitori non diplomati?",
            options: ["Circa 15%", "Circa 25%", "Circa 42%", "Oltre il 60%"],
            correct: 2,
            explanation: "Il 42% degli studenti dei professionali ha genitori senza diploma, contro meno del 10% nei licei. L'origine determina il percorso."
        },
        {
            question: "Come si posiziona l'Italia per numero di laureati (25-34 anni) rispetto alla media OCSE?",
            options: ["Sopra la media", "In linea con la media", "Tra gli ultimi posti"],
            correct: 2,
            explanation: "L'Italia è penultima in Europa per numero di laureati, superata solo dalla Romania."
        },
        {
            question: "Quanto guadagna un docente italiano di scuola superiore rispetto a un collega tedesco (a parità di potere d'acquisto)?",
            options: ["Lo stesso", "Circa il 10% in meno", "Meno della metà"],
            correct: 2,
            explanation: "Un docente tedesco guadagna oltre il doppio (€72k vs €34k) dopo 15 anni di carriera."
        }
    ]
};
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                tooltip: {
                    callbacks: {
                        label: (ctx) => `${ctx.raw.label}: Punteggio ${ctx.raw.y} (ESCS: ${ctx.raw.x})`
                    }
                },
            ...
            scales: {
                x: {
                    title: { display: true, text: 'Background Socio-Economico (Indice ESCS)' },
                    min: -1.5, max: 1.5
                },
                y: {
                    title: { display: true, text: 'Punteggio Medio INVALSI (Matematica)' },
                    min: 150, max: 250
                }
            }
        }

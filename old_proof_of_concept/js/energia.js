...
const energyData = {
    ...
    quiz: [
        {
            question: "Qual è la fonte energetica primaria usata in Italia per produrre elettricità?",
            options: ["Idroelettrico", "Gas Naturale", "Carbone", "Nucleare (importato)"],
            correct: 1,
            explanation: "Il Gas Naturale (circa 45% del mix) è la nostra fonte primaria."
        },
        {
            question: "L'Italia è al momento autosufficiente nella produzione di gas naturale?",
            options: ["Sì, al 100%", "No, importiamo oltre il 90%", "No, importiamo circa il 50%"],
            correct: 1,
        ...
        },
        {
            ...
            correct: 2,
            explanation: "Nucleare, Eolico e Solare hanno le emissioni più basse per kWh prodotto."
        }
    ]
};
...
function createEnergyMixChart(canvasId, initialMix) {
    ...
    const labels = {
        gas: 'Gas Naturale', oil_coal: 'Petrolio & Carbone', hydro: 'Idroelettrico',
        solar_wind: 'Solare & Eolico', nuclear: 'Nucleare', other: 'Altro/Import'
    };
...
function renderQuestion() {
    ...
    question.options.forEach((option, index) => {
        ...
        } else if (quizEngine.selectedAnswers[quizEngine.currentQuestion] === index) {
